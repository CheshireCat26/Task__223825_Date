...
void heapSort(vector<Date> &mass);
void outMass(vector<Date> &mass);
...
void buildTree(vector<Date> &mass,int root, int size);
void heapSort(vector<Date> &mass){
...
void recBuildTree(vector<Date> &mass,int root, int size);
void buildTree(vector<Date> &mass,int root, int size){
...
void outDebug(vector<Date> &mass,int root, int left, int right){
    cout << "Mass:" << endl;
    outMass(mass);
